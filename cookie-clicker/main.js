...
var VERSION=2.021;
var BETA=1;
var SaveFileExtension = "ccsave"; // This is the file extension save files will have
...
Game.Launch=function()
{
  ...
  Game.Init=function()
  {
    ...
    {
      return (Math.random()>0.05?(choose(['Magic','Fantastic','Fancy','Sassy','Snazzy','Pretty','Cute','Pirate','Ninja','Zombie','Robot','Radical','Urban','Cool','Hella','Sweet','Awful','Pneumonoultramicroscopicsilicovolcanoconiosis','Double','Triple','Turbo','Techno','Disco','Electro','Dancing','Wonder','Mutant','Space','Science','Medieval','Future','Captain','Bearded','Lovely','Stupid','Tiny','Big','Fire','Water','Frozen','Metal','Plastic','Solid','Liquid','Moldy','Shiny','Happy','Happy Little','Slimy','Tasty','Delicious','Hungry','Greedy','Poop','Lethal','Professor','Doctor','Power','Chocolate','Crumbly','Choklit','Righteous','Glorious','Mnemonic','Psychic','Frenetic','Hectic','Crazy','Royal','El','Von'])+' '):'Mc')+choose(['Cookie','Biscuit','Nerd','Muffin','Scone','Cupcake','Pancake','Chip','Sprocket','Gizmo','Puppet','Mitten','Sock','Teapot','Mystery','Baker','Cook','Grandma','Click','Clicker','Spaceship','Factory','Portal','Machine','Experiment','Monster','Panic','Burglar','Bandit','Booty','Potato','Pizza','Burger','Sausage','Meatball','Spaghetti','Macaroni','Kitten','Puppy','Giraffe','Zebra','Parrot','Dolphin','Duckling','Sloth','Turtle','Goblin','Pixie','Gnome','Computer','Pirate','Ninja','Zombie','Robot','Pneumonoultramicroscopicsilicovolcanoconiosis']);
    }
    ...
    Game.FileSave=function()
    {
      ...
      saveAs(blob,filename+`.${SaveFileExtension}`);
    }
    ...
    Game.getNewTicker=function(manual)//note : "manual" is true if the ticker was clicked, but may also be true on startup etc
    {
      ...
      if (Game.TickerN%2==0 || Game.cookiesEarned>=10100000000)
      {
        ...
        if (Math.random()<0.75 || Game.cookiesEarned<10000)
        {
          ...
          "You're going to peepee poopoo land!",
          "I am better than you haha"
          ]));
          ...
          "News : Someone pooped on the cookies!"
          ]));
      ...
      if (Game.season=='fools')
      {
        ...
        else if (Game.cookiesEarned<10000) list.push('You are now cool.');
        ...
        else if (Game.cookiesEarned<50100000000) list.push('BRO GO TOUCH GRASS!!');
      }
